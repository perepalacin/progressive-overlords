...
public final class JteongoingworkoutviewGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,0,0,4,4,4,4,5,5,6,6,7,7,8,8,9,9,10,10,11,11,11,11,11,0,1,2,2,2,2};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, progressive_overlords.entities.dao.WorkoutDao workout, boolean isFinished, boolean isEditable) {
		...
		gg.jte.generated.ondemand.JtemainGenerated.render(jteOutput, jteHtmlInterceptor, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				if (isFinished) {
					jteOutput.writeContent("\n        ");
					gg.jte.generated.ondemand.components.workouts.JtefinishedworkoutviewGenerated.render(jteOutput, jteHtmlInterceptor, workout, isEditable);
					jteOutput.writeContent("\n    ");
				} else {
					jteOutput.writeContent("\n        ");
	...
	public static void renderMap(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, java.util.Map<String, Object> params) {
		...
		render(jteOutput, jteHtmlInterceptor, workout, isFinished, isEditable);
	}
}
