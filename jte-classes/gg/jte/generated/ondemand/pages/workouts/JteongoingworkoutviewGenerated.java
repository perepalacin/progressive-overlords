...
public final class JteongoingworkoutviewGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,0,0,2,2,2,2,5,5,5,7,7,7,8,8,8,8,15,15,15,15,15,15,15,15,15,18,18,19,19,20,20,20,20,20,20,20,20,23,23,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,28,28,28,28,28,28,28,28,28,28,28,28,28,29,29,29,29,29,29,29,29,29,39,39,39,39,39,39,39,39,39,39,39,39,39,40,40,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,44,44,45,45,45,45,45,45,45,45,45,46,46,47,47,47,47,47,47,47,47,47,48,48,48,48,48,48,48,48,48,49,49,49,49,49,49,49,49,49,50,50,50,50,50,50,50,50,50,53,53,53,56,56,56,56,56,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,59,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,65,65,66,66,66,66,69,69,73,73,75,75,77,77,82,82,86,86,86,86,86,86,86,86,86,90,90,92,92,103,103,103,109,109,109,111,111,111,0,0,0,0};
			...
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				if (workout != null && workout.getExercises() != null) {
					...
					for (int i = 0; i < workout.getExercises().size(); i++) {
						...
						jteOutput.writeContent("\" class=\"exercise-item-");
						...
						jteOutput.setContext("button", null);
						jteOutput.writeContent("&workoutId=");
						jteOutput.setContext("button", "hx-delete");
						jteOutput.writeUserContent(workout.getId());
						jteOutput.setContext("button", null);
						jteOutput.writeContent("\" hx-swap=\"outerHTML\" hx-target=\"#exercise-item-");
						jteOutput.setContext("button", "hx-target");
						jteOutput.writeUserContent(i);
						jteOutput.setContext("button", null);
						jteOutput.writeContent("\" type=\"button\"");
