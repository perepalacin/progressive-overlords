...
public class TemplatesRepository {
    ...
    public List<TemplateDao> getAllByUserId(UUID userId) {
        String sql = "SELECT id, name, description, color, body_part, tags FROM workout_templates WHERE user_id = ?";

        return jdbcTemplate.query(sql, new Object[]{userId}, (rs, rowNum) -> {
            return new TemplateDao(rs.getInt("id"),rs.getString("name"), rs.getString("description"), rs.getString("color"), rs.getString("body_part"), rs.getString("tags"));
        });
    }
